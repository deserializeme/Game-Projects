    ...
    public class Timing : MonoBehaviour
    {
        ...
        void OnEditorUpdate()
        {
            ...
            if (_nextEditorUpdateProcessSlot > 0)
            {
                ...
                for (int i = 0; i < _nextEditorUpdateProcessSlot; i++)
                {
                    UnityEngine.Profiling.Profiler.BeginSample("Processing Coroutine (Editor Update)");
                    ...
                    if (EditorUpdateProcesses[i] != null && !(EditorApplication.timeSinceStartup < EditorUpdateProcesses[i].Current))
                    {
                        ...
                        catch (System.Exception ex)
                        {
                            if (OnError == null)
                                ...
                                OnError(ex, EditorUpdateProcesses[i]);
                    ...
                    if (!_runningEditorUpdate)
                    {
                        ...
                        catch (System.Exception ex)
                        {
                            if (OnError == null)
                                ...
                                OnError(ex, EditorUpdateProcesses[currentSlot]);
